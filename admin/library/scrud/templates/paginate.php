...
<div class="pagination pagination-right">
    <div style="float:left; padding-top:6px;"><?php echo __LBL_TOTAL__; ?>: <?php echo $this->totalRecord; ?> / <?php echo $this->totalPage; ?> <?php echo __LBL_PAGE__; ?></div>
        ...
        <?php if (!empty($this->results) && (int) $this->totalPage > 1) { ?>
            <?php if ($this->pageIndex > 1 && $this->totalRecord > 0) { ?>
                <li><a onclick="paginate(1);
                            return false;" href="#">First</a></li>
                <li><a onclick="paginate(<?php echo $this->pageIndex - 1; ?>);
                            return false;" href="#">&laquo;</a></li>
                <?php } else { ?>
            ...
            <?php for ($i = $f; $i <= $l; $i++) { ?>
                ...
                <?php } else { ?>
                    <li><a onclick="paginate(<?php echo $i; ?>);
                                return false;" href="#"><?php echo $i; ?></a></li>
                    <?php } ?>
                <?php } ?>
                <?php if ($this->pageIndex != $this->totalPage && $this->totalRecord > 0) { ?>
                <li><a onclick="paginate(<?php echo $this->pageIndex + 1; ?>);
                            return false;" href="#">&raquo;</a></li>
                <li><a onclick="paginate(<?php echo $this->totalPage; ?>);
                            return false;" href="#">Last</a></li>
                <?php } else { ?>
