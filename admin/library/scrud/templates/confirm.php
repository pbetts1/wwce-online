    ...
    <div data-spy="affix" data-offset-top="50" style="
        ...
        <div class="container" style="border-bottom: 1px solid #CCC; padding-bottom:5px;padding-top:5px;
            ...
            <div style="text-align:right; width:100%;">
                ...
                <a class="btn btn-info" onclick="crudUpdate();" > &nbsp;  <i class="icon-ok icon-white"></i>  <?php echo __BTN_SAVE__; ?> &nbsp; </a>
            </div>
        </div>
    </div>
    </div>
...
<div class='x-table well <?php echo $this->conf['color']; ?>' style="background:#FBFBFB;">
    <!-- <h3 style="margin-top: 7px;"><?php echo $this->title; ?>
    <?php if (isset($_GET['key']) || isset($_POST['key'])) { ?>
                    <span>(Edit)</span>
    <?php } else { ?>
                    <span>(New)</span>
    <?php } ?>
                    ...
                    ?>
                    	<div class="control-group">
                            ...
                            <div class="controls" style="padding-top:5px;">
                                ...
                                echo __hidden('data.' . $field,$elements);
                                switch ($elements[0]) {
                                    case 'image':
                                    case 'editor':
