    ...
    <div data-spy="affix" data-offset-top="50" style="
        ...
        <div class="container" style="border-bottom: 1px solid #CCC; padding-bottom:5px;padding-top:5px;
            ...
            <div style="text-align:right;width:100%;">
                <a class="btn"  onclick="crudCancel();">  &nbsp; <?php echo __BTN_CANCEL__; ?>  &nbsp; </a>
                <a class="btn btn-info" onclick="crudConfirm();" > &nbsp;  <i class="icon-edit icon-white"></i>  <?php echo __BTN_CONFIRM__; ?> &nbsp; </a>
            </div>
        </div>
    </div>
    </div>
