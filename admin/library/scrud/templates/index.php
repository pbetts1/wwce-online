    ...
    <div data-spy="affix" data-offset-top="50" style="
        ...
        <div class="container" style="border-bottom: 1px solid #CCC; padding-bottom:5px;padding-top:5px;
            ...
            <div style="text-align:right;width:100%;">
            	<div class="btn-group">
                <a class="btn" onclick="searchModal();"><i class="icon-search"></i> <?php echo __BTN_SEARCH__;?></a>
	                <?php
			        $q = $this->queryString;
			        if (isset($q['xtype']))
			            unset($q['xtype']);
                ...
                <?php if (!empty($this->results)) { ?>
                    <a class="btn"  onclick="crudExport();"><i class="icon-download"></i> <?php echo __BTN_EXPORT_CSV__;?></a>
                <?php } else { ?>
                    <a class="btn disabled"><i class="icon-download"></i> <?php echo __BTN_EXPORT_CSV__;?></a>
                <?php } ?>
                <a class="btn"  onclick="crudExportAll();"><i class="icon-download"></i> <?php echo __BTN_EXPORT_CSV_ALL__;?></a>
                <?php if (in_array(1, $permissions))  { ?>
                    <a type="button" class="btn btn-info" onclick="newRecord();"> <i class="icon-plus icon-white"></i> <?php echo (__BTN_ADD__); ?></a>
                <?php } ?>
            </div>
        </div>
    </div>
            ...
            <div style="overflow: auto;">
                <table class="table table-bordered table-hover list table-condensed">
                    ...
                    <tbody>
                                                ...
                                                if (isset($this->form[$field]) && isset($this->form[$field]['element'][0])) {
                                                    switch (trim(strtolower($this->form[$field]['element'][0]))) {
                                                        ...
                                                        case 'textarea':
                                                            ...
                                                            break;
                                                        case 'file':
                                                            if (file_exists(ROOT . '/public/media/files/' . $__value)) {
                                                                echo '<a href="' . strUrl('admin/download.php?file=' . $__value ) . '">' . $__value . '</a>';
                                                            } else {
                                                                echo $__value;
                                                            }
                                                            break;
                                                        case 'image':
                                                            if (file_exists(__IMAGE_UPLOAD_REAL_PATH__ . '/thumbnail_' . $__value)) {
                                                                echo "<img src='" . __IMAGE_PATH__ . "thumbnail_" . $__value . "' />";
                                                            } else if (__IMAGE_UPLOAD_REAL_PATH__ . '/mini_thumbnail_' . $__value) {
                                                                echo "<img src='" . __IMAGE_PATH__ . "mini_thumbnail_" . $__value . "' />";
                                                            } else {
                                                                echo '';
                                                            }
                                                            break;
                        ...
                        <?php } else { ?>
                            <tr>
                                <td colspan="<?php echo count($fields); ?>"><?php echo __LBL_NO_DATA__;?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
