...
<div class="container" >
        ...
        <h3 style="margin-top: 7px;"><?php if ($editFlag == true) { ?>Edit<?php } else { ?>Create<?php } ?> table</h3>
        ...
        <form class="form-horizontal" id="frm_new_table">
            ...
            <table class="table table-bordered list table-condensed" id="crud_table">
                ...
                <tr style="display:none;" id="template">
                    ...
                    <td style="text-align: center;">
                        <a class="btn btn-info btn-mini" onclick="add_field(this);">Add</a>
            ...
            <div style="text-align: center;">
                ...
                <?php if ($editFlag == true) { ?>
                    <input type="button" class="btn btn-info" value=" Save " onclick="updateTable();" />
                <?php } else { ?>
                    <input type="button" class="btn btn-info" value=" Save " onclick="createNewTable();" />
                <?php } ?>
            </div>
        </form>
        <footer>
