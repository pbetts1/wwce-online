<form class="form-horizontal">
	<div id="dataListConfigCommon" style="margin-top: 10px;">
	    <div class="control-group">
	        <label class="control-label" for="crudTitle"><b><?php echo __LBL_TITLE__;?></b> </label>
	        <div class="controls">
	            <input type="text" id="crudTitle" name="crud[title]">
	        </div>
	    </div>
	    <div class="control-group">
	        <label class="control-label" for="crudRowsPerPage"><b><?php echo __LBL_ROWS_PER_PAGE__;?></b>
	        </label>
	        <div class="controls">
	    ...
	    <div class="control-group">
	        <label class="control-label" for="crudOrderField"><b><?php echo __LBL_ORDER_BY__;?></b> </label>
	        <div class="controls">
	            ...
	            <select style="width: auto;" name="crud[order_type]" id="crudOrderType">
	                <option value=""></option>
	                <option value="asc"><?php echo __LBL_ORDER_ASC__;?></option>
	                <option value="desc"><?php echo __LBL_ORDER_DESC__;?></option>
	            </select>
	        </div>
	    </div>
            <div class="control-group">
                    <label class="control-label" for="crudNoColumn"><b><?php echo __LBL_NO_COLUMN__;?></b></label>
                    <div class="controls">
                        <input type="checkbox" value="1" id="crudNoColumn">
                    </div>
                </div>
	    <div class="control-group">
	        <label class="control-label"><b><?php echo __LBL_JOIN__;?></b> </label>
	        <div class="controls">
    ...
    <div>
        <ul id="dataListConfigElement" class="nav nav-tabs">
            <li class="active"><a href="#filter" data-toggle="tab">
            	<?php echo __LBL_FILTER_ELEMENT__;?>
            </a></li>
            <li><a href="#column" data-toggle="tab"><?php echo __LBL_COLUMN_ELEMENT__;?></a></li>
        </ul>
